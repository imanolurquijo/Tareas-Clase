...
public class VistaAlta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALTA DE ABOGADOS");
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
        try
        {
            DespachoAbogados.altaAbogado(tfDni.getText(),tfNombre.getText(),tfApellidos.getText(),tfDireccion.getText());
            JOptionPane.showMessageDialog(this,"Abogado dado de alta");
            DespachoAbogados.volver(this);
        }
        catch(Exception e)
        {
